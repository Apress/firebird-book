 ...
 *
 * All Rights Reserved.
 * Contributor(s): Helen Borrie, Firebird Project, January 2004.
 */
...
/* L I N U X */
create database '/opt/firebird/examples/employee.fdb'
/* W I N 3 2 */
/* create database 'c:\Program Files\Firebird\Firebird_1_5\examples\employee.fdb' */
